 ...
 */
public class AnonCommandTest extends CommandTest
  {
  @Test
  ...
  public void whenInputStdin() throws Exception
    ...
    runWithStdIO( () -> AnonCommand.run( new Options( args)), inFile, anonymized);
  ...
  public void whenAnnotations() throws Exception
    ...
    // When...
    StringBuffer anonymized = new StringBuffer();
    runWithStdIO( () -> AnonCommand.run( new Options( args)), null, anonymized);
