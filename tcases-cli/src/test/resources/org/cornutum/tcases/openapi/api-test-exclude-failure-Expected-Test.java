...
public class OpenAPIRequestTestCasesTest {
    ...
    public void putPost_PostIdValue_Is_Gt_0() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "postId", "750350738048324045.1")
                .contentType( "application/x-www-form-urlencoded")
    ...
    public void postPosts_ApprovedDefined_Is_Yes() {
        Response response =
            given()
                ...
                .request().body( "{\"text\":\"\",\"email\":\"H@k.net\"}")
            .when()
                .request( "POST", "/posts")
            .then()
                .statusCode( isSuccess())
    ...
    public void postPosts_BodyApplicationJsonValuePropertiesEmailValueLength_Is_32() {
        Response response =
            given()
                ...
                .cookie( "approved", "true")
                .contentType( "application/json")
                .request().body( "{\"text\":\"l J8CC`5,YnP]d,C#\\\\8J+8{zQ\\\"dSJFz^Cn\\\\R0hO3(BG;K\\\\Z+],z=:IHT]dJ*c,[<\",\"email\":\"4XE5A&_oG@Bjw.z2LX.t2J1.MrGe.com\"}")
            .when()
                .request( "POST", "/posts")
            .then()
                .statusCode( isSuccess())
    ...
    public void tracePostsAttributes_AttributesValuePropertiesApprovedValue_Is_False() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "attributes", ";approved=false;likes=577811703")
            .when()
                .request( "TRACE", "/posts/{attributes}")
            .then()
                .statusCode( isSuccess())
    ...
    public void deletePostsUserIdAttributes_AttributesValuePropertiesApprovedDefined_Is_No() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "[attributes]", "likes=1043412266")
                .pathParam( "userId", "0")
            .when()
                .request( "DELETE", "/posts/{userId}/{[attributes]}")
            .then()
