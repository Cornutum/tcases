...
public class OpenAPIRequestTestCasesTest {
    ...
    public void headPost_UserAttributesValuePropertiesUserTypeValue_Is_Other() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "post?[post references]", "0,2")
                .queryParam( "user attributes", "user type,<]pwMtKA6.rR1B2;cO=8.VV%GB!C?II9J][uXY]Z=?h>TK}m$+F!>wxEWHcL")
            .when()
                .request( "HEAD", "/post")
            .then()
    ...
    public void headPost_UserAttributesValuePropertiesAdditional_Is_Yes() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "post?[post references]", "0,2")
                .queryParam( "user attributes", "user type,VIP!,vnpulqutclqwz,(c4H1uh")
            .when()
                .request( "HEAD", "/post")
            .then()
    ...
    public void headPost_PostValuePropertiesPostReferencesType_Is_NotArray() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "post?[post references]", "884")
                .queryParam( "user attributes", "user type,VIP!")
            .when()
                .request( "HEAD", "/post")
            .then()
    ...
    public void headPost_PostValuePropertiesPostReferencesItemsContainsType_Is_NotInteger() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "post?[post references]", ",<yq,0")
                .queryParam( "user attributes", "user type,VIP!")
            .when()
                .request( "HEAD", "/post")
            .then()
    ...
    public void headPost_PostValuePropertiesPostReferencesItemsContainsValue_Is_Other() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "post?[post references]", "840320398,0")
                .queryParam( "user attributes", "user type,VIP!")
            .when()
                .request( "HEAD", "/post")
            .then()
    ...
    public void headPost_PostValuePropertiesAdditional_Is_Yes() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "post?[post references]", "0,2")
                .queryParam( "post?[fnevpedqe]", ":461Sfr")
                .queryParam( "post?[geotdwkzwb]", "'")
                .queryParam( "user attributes", "user type,VIP!")
            .when()
                .request( "HEAD", "/post")
            .then()
    ...
    public void patchPost_PostMarksType_Is_NotArray() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "Post Marks", "km true nciu true zjwdvhceipujk true")
            .when()
                .request( "PATCH", "/post")
            .then()
    ...
    public void patchPost_PostMarksItemsContainsValue_Is_Other() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "Post Marks", "hlguvAL<aV1N$#%Uh{o@0}?]*6IUB5-nUs?QtjO!PcFJ,`?\\Cst|jd}SmAvd=!W$KN+VY<^m;Tt]jLFt}?=eF{V3mBF:-b/v]jHx-fjS]y,ovAvv]lX6LCx6HT!=?7Jt*}'6\"_2_e&TKUQu4W(h{Dx$gcHqi}xyt9?w|Z@h$tx{U4[9lddD|&#G@^v]`2^LMsq[P!dDWgE[#cLX&El|P1h'\"MfsJsOj7}-g=")
            .when()
                .request( "PATCH", "/post")
            .then()
    ...
    public void putPost_BodyDefined_Is_No() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "postId", "25359957057464094.9")
            .when()
                .request( "PUT", "/post")
            .then()
                // Body.Defined=No
    ...
    public void putPost_BodyMediaType_Is_Other() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "postId", "111848948117844792.4")
    ...
    public void putPost_BodyApplicationXWwwFormUrlencodedType_Is_Null() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "postId", "705914181701075101.8")
                .contentType( "application/x-www-form-urlencoded")
            .when()
                .request( "PUT", "/post")
            .then()
    ...
    public void putPost_BodyApplicationXWwwFormUrlencodedType_Is_NotObject() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "postId", "246941193240489622.9")
                .contentType( "application/x-www-form-urlencoded")
                .formParam( "0", "~?-ql'h")
            .when()
                .request( "PUT", "/post")
    ...
    public void putPost_BodyApplicationXWwwFormUrlencodedValuePropertiesApprovedType_Is_NotBoolean() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "postId", "388543222853633836.1")
                .contentType( "application/x-www-form-urlencoded")
                .formParam( "approved", "1004")
                .formParam( "reviewer", "Larry Moe")
            .when()
                .request( "PUT", "/post")
            .then()
    ...
    public void putPost_BodyApplicationXWwwFormUrlencodedValuePropertiesReviewerValue_Is_Other() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "postId", "484359011236212845.9")
                .contentType( "application/x-www-form-urlencoded")
                .formParam( "approved", "false")
                .formParam( "reviewer", "6rU=~*8j09EHtm6#-VembB!vNDkwjip=4vVrqg>/N_pt\"bE5RL6baS'0ce@1 tL\"GO7 6@_BlW>7G+?\"AnqR~qOd'fg4^> YiY}")
            .when()
                .request( "PUT", "/post")
            .then()
    ...
    public void putPost_BodyApplicationXWwwFormUrlencodedValuePropertiesAdditional_Is_Yes() {
        Response response =
            given()
                .baseUri( forTestServer())
                .queryParam( "postId", "622428293568448186.8")
                .contentType( "application/x-www-form-urlencoded")
                .formParam( "approved", "false")
                .formParam( "reviewer", "Larry Moe")
                .formParam( "lq", "629")
    ...
    public void deletePostUserIdApproved_UserIdType_Is_NotInteger() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "approved", ".0")
                .pathParam( "userId", ".reqxgwntxckpjg.-51")
            .when()
                .request( "DELETE", "/post/{userId}/{approved}")
            .then()
    ...
    public void optionsPosts_XPostTypesType_Is_NotArray() {
        Response response =
            given()
                .baseUri( forTestServer())
                .header( "X-Post-Types", "d^q")
                .header( "X-User-Id", "209965593")
            .when()
                .request( "OPTIONS", "/posts")
            .then()
    ...
    public void optionsPosts_XPostTypesItemsContainsType_Is_NotInteger() {
        Response response =
            given()
                .baseUri( forTestServer())
                .header( "X-Post-Types", "5mh-,7700")
                .header( "X-User-Id", "315069508")
            .when()
                .request( "OPTIONS", "/posts")
            .then()
    ...
    public void optionsPosts_XPostTypesItemsContainsValue_Is_Other() {
        Response response =
            given()
                .baseUri( forTestServer())
                .header( "X-Post-Types", "343417131,7700")
                .header( "X-User-Id", "423082741")
            .when()
                .request( "OPTIONS", "/posts")
            .then()
    ...
    public void postPosts_BodyApplicationJsonValuePropertiesEmailValueLength_Is_6() {
        Response response =
            given()
                ...
                .cookie( "approved", "false")
                .contentType( "application/json")
                .request().body( "{\"text\":\"\",\"email\":\"_H.edu\"}")
            .when()
                .request( "POST", "/posts")
            .then()
    ...
    public void postPosts_BodyApplicationJsonValuePropertiesEmailValueLength_Is_33() {
        Response response =
            given()
                ...
                .cookie( "approved", "false")
                .contentType( "application/json")
                .request().body( "{\"text\":\"\",\"email\":\"En.;$_.LuJ.D+L.q73.VUi@5X.VD9.net\"}")
            .when()
                .request( "POST", "/posts")
            .then()
    ...
    public void postPosts_BodyApplicationJsonValuePropertiesTextType_Is_Null() {
        Response response =
            given()
                ...
                .cookie( "approved", "false")
                .contentType( "application/json")
                .request().body( "{\"text\":null,\"email\":\"B@r.net\"}")
            .when()
                .request( "POST", "/posts")
            .then()
    ...
    public void postPosts_BodyApplicationJsonValuePropertiesTextType_Is_NotString() {
        Response response =
            given()
                ...
                .cookie( "approved", "false")
                .contentType( "application/json")
                .request().body( "{\"text\":871.4,\"email\":\"N@r.net\"}")
            .when()
                .request( "POST", "/posts")
            .then()
    ...
    public void postPosts_BodyApplicationJsonValuePropertiesTextValueLength_Is_65() {
        Response response =
            given()
                ...
                .cookie( "approved", "false")
                .contentType( "application/json")
                .request().body( "{\"text\":\"c!FO\\\\TOZ9\\\"QK@+$br\\\\%w}2O)lmlw#Q(SL6gy6*(`.$Fmkz{P>=HQy>ILCo`w?;e$@\",\"email\":\"b@T.net\"}")
            .when()
                .request( "POST", "/posts")
            .then()
    ...
    public void postPosts_BodyApplicationJsonValuePropertiesAdditional_Is_Yes() {
        Response response =
            given()
                ...
                .cookie( "approved", "false")
                .contentType( "application/json")
                .request().body( "{\"text\":\"\",\"email\":\"x@6.org\",\"qdxw\":350.9,\"mrxpjbaygw\":{\"vaqalrvq\":true,\"fjkjfyhbur\":299.4,\"zqwtffcczgbq\":-246.7},\"yqucfqqdfb\":[]}")
            .when()
                .request( "POST", "/posts")
            .then()
    ...
    public void putPosts_PostIdValuePropertiesAdditional_Is_Yes() {
        Response response =
            given()
                ...
                .cookie( "country", "0")
                .cookie( "region", "-")
                .cookie( "xgwtqoghbxdvc", "-911")
                .cookie( "xdj", "-738")
                .contentType( "text/plain")
                .request().body( "{\"text\":\"\",\"email\":\"5@I.edu\"}")
            .when()
                .request( "PUT", "/posts")
            .then()
    ...
    public void putPosts_BodyTextPlainValuePropertiesEmailValueLength_Is_33() {
        Response response =
            given()
                ...
                .cookie( "region", "Z")
                .contentType( "text/plain")
                .request().body( "{\"text\":\"\",\"email\":\"C@GxW.9V.Uy.7P.Kv.0v.rK.Ua.jT.net\"}")
            .when()
                .request( "PUT", "/posts")
            .then()
    ...
    public void putPosts_BodyTextPlainValuePropertiesTextType_Is_Null() {
        Response response =
            given()
                ...
                .cookie( "region", "0")
                .contentType( "text/plain")
                .request().body( "{\"text\":null,\"email\":\"N@E.com\"}")
            .when()
                .request( "PUT", "/posts")
            .then()
    ...
    public void putPosts_BodyTextPlainValuePropertiesTextValueLength_Is_65() {
        Response response =
            given()
                ...
                .cookie( "region", "l")
                .contentType( "text/plain")
                .request().body( "{\"text\":\"5oXDS:6kGbu7hpwCtKd`560|E U&=Tvy)0BVvr\\\\4e$S`F]~%X&v~KbwBZX=\\\"l1\\\",E\",\"email\":\"g@9.gov\"}")
            .when()
                .request( "PUT", "/posts")
            .then()
    ...
    public void putPosts_BodyTextPlainValuePropertiesAdditional_Is_Yes() {
        Response response =
            given()
                ...
                .cookie( "region", "0")
                .contentType( "text/plain")
                .request().body( "{\"text\":\"\",\"email\":\"S@M.com\",\"o\":-246.5,\"jbwqvplab\":true,\"zgxcc\":true}")
            .when()
                .request( "PUT", "/posts")
            .then()
    ...
    public void tracePosts_PostIdItemsContainsValue_Is_Other() {
        Response response =
            given()
                .baseUri( forTestServer())
                .cookie( "postId", "@-gs5gZFdIi6B#N?xOsn]1Q}yh*NC[l}>wH*NzR^O<Wmc3Ki*cX*cmpr*bafLCX7gkWk/.B#c=nrqFEo~xo[(+Dwp_$pzgETGcjaAhgRIzYt[<s27WRs316H]#4[{':9Y7DzYRD@B%J('LiOFjsS#I+eWn)XB/5gkakT07>12+3TjrE-a=Tk|C")
            .when()
                .request( "TRACE", "/posts")
            .then()
    ...
    public void tracePostsAttributes_AttributesType_Is_NotObject() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "attributes", ";attributes=dW\\=z;attributes=v/tD")
            .when()
                .request( "TRACE", "/posts/{attributes}")
            .then()
    ...
    public void tracePostsAttributes_AttributesValuePropertiesApprovedDefined_Is_No() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "attributes", ";likes=3208798")
            .when()
                .request( "TRACE", "/posts/{attributes}")
            .then()
    ...
    public void tracePostsAttributes_AttributesValuePropertiesApprovedType_Is_Null() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "attributes", ";approved;likes=677709468")
            .when()
                .request( "TRACE", "/posts/{attributes}")
            .then()
    ...
    public void tracePostsAttributes_AttributesValuePropertiesApprovedType_Is_NotBoolean() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "attributes", ";approved=-642;likes=870781229")
            .when()
                .request( "TRACE", "/posts/{attributes}")
            .then()
    ...
    public void tracePostsAttributes_AttributesValuePropertiesLikesType_Is_NotInteger() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "attributes", ";approved=false;likes=o1p]B")
            .when()
                .request( "TRACE", "/posts/{attributes}")
            .then()
    ...
    public void tracePostsAttributes_AttributesValuePropertiesSubjectType_Is_Null() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "attributes", ";approved=false;subject;likes=998920180")
            .when()
                .request( "TRACE", "/posts/{attributes}")
            .then()
    ...
    public void tracePostsAttributes_AttributesValuePropertiesSubjectValue_Is_Other() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "attributes", ";approved=false;subject=\\(u&Y86kCr!B?g9uE >jb1V(Arh~)u90wz?VCm-4uMO!Z&4v\">gb//V~cOamLd\"guT=(|fwcJYu&H7cwat!)7U*9%m#/E\\xaR C3L$L!7CuE^D`zivT 8KY2G\"'?FjW?la&:<{E&>9t6sxMPPkU\"t6BzKl0n)<r-5ca7J,/U#OG;;,p-jforEO=_lZy\"U R~*T(\"i,Z%$ 3uJ6g}6@[TS7&oeK>57gl+z:q8#s'sYn  /FfzE.buMUx!d;likes=85598741")
            .when()
                .request( "TRACE", "/posts/{attributes}")
            .then()
    ...
    public void tracePostsAttributes_AttributesValuePropertiesAdditional_Is_Yes() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "attributes", ";approved=false;likes=281915723;dt")
            .when()
                .request( "TRACE", "/posts/{attributes}")
            .then()
    ...
    public void deletePostsUserIdAttributes_UserIdType_Is_NotInteger() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "[attributes]", "approved=true")
                .pathParam( "userId", "n5mQS,Duq,n?NEt")
            .when()
                .request( "DELETE", "/posts/{userId}/{[attributes]}")
            .then()
                // userId.Type=Not integer
    ...
    public void deletePostsUserIdAttributes_AttributesType_Is_NotObject() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "[attributes]", "ps]R+Y)")
                .pathParam( "userId", "817274808")
            .when()
                .request( "DELETE", "/posts/{userId}/{[attributes]}")
            .then()
                // attributes.Type=Not object
    ...
    public void deletePostsUserIdAttributes_AttributesValuePropertiesApprovedType_Is_NotBoolean() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "[attributes]", "approved=(o")
                .pathParam( "userId", "654152602")
            .when()
                .request( "DELETE", "/posts/{userId}/{[attributes]}")
            .then()
                // attributes.Value.Properties.approved.Type=Not boolean
    ...
    public void deletePostsUserIdAttributes_AttributesValuePropertiesLikesType_Is_NotInteger() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "[attributes]", "approved=true,likes=6B")
                .pathParam( "userId", "62387746")
            .when()
                .request( "DELETE", "/posts/{userId}/{[attributes]}")
            .then()
                // attributes.Value.Properties.likes.Type=Not integer
    ...
    public void deletePostsUserIdAttributes_AttributesValuePropertiesAdditional_Is_Yes() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "[attributes]", "approved=true,uuoupawwypkhjln=//y3OO,aafrhdtipcg=true,scu=77")
                .pathParam( "userId", "644525588")
            .when()
                .request( "DELETE", "/posts/{userId}/{[attributes]}")
            .then()
                // attributes.Value.Properties.Additional=Yes
