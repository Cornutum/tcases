...
[![Maven](https://img.shields.io/badge/maven-4.1.1-green.svg)](https://search.maven.org/search?q=tcases-shell)
[![Javadoc](https://img.shields.io/badge/javadoc-4.1.1-green.svg)](https://javadoc.io/doc/org.cornutum.tcases/tcases-shell)

## What's New? ##
  * The latest version ([Tcases 4.1.1](ReleaseNotes.md#411)) is now available at the Maven Central Repository.
