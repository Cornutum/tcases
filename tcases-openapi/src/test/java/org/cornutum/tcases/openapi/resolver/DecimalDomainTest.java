...
public class DecimalDomainTest extends ValueDomainTest
  ...
  public void whenNotMultipleOf()
    ...
    assertThat( "Value", domain.select( getResolverContext()), matches( dataValueMatcher( new BigDecimal( "8.0"), Type.NUMBER, "float")));
  ...
  public void whenConstant()
    ...
    assertThat( "Constant value", domain.select( getResolverContext()), matches( dataValueMatcher( new BigDecimal( "-123456789.0"), Type.NUMBER, "double")));
    }
