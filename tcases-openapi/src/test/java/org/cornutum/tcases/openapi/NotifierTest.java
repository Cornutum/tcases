...
public class NotifierTest extends OpenApiTest
  ...
  public void errorWhenInfeasibleBounds()
    ...
    assertConditions(
      Arrays.asList(
        "Object,/object,POST,param0: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
  ...
  public void errorWhenInvalidStyles()
    ...
    assertConditions(
      Arrays.asList(
        "Styles,/query/object,GET,matrixParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/query/object,GET,labelParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/query/object,GET,formParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/query/object,GET,simpleParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/query/object,GET,spaceDelimitedParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/query/object,GET,pipeDelimitedParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/query/object,GET,deepObjectParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/header/object,GET,matrixParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/header/object,GET,labelParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/header/object,GET,formParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/header/object,GET,simpleParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/header/object,GET,spaceDelimitedParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/header/object,GET,pipeDelimitedParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/header/object,GET,deepObjectParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/cookie/object,GET,formParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/path/object/{matrixParam}/{labelParam}/{formParam}/{simpleParam}/{spaceDelimitedParam}/{pipeDelimitedParam}/{deepObjectParam},GET,formParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/path/object/{matrixParam}/{labelParam}/{formParam}/{simpleParam}/{spaceDelimitedParam}/{pipeDelimitedParam}/{deepObjectParam},GET,simpleParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/path/object/{matrixParam}/{labelParam}/{formParam}/{simpleParam}/{spaceDelimitedParam}/{pipeDelimitedParam}/{deepObjectParam},GET,spaceDelimitedParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/path/object/{matrixParam}/{labelParam}/{formParam}/{simpleParam}/{spaceDelimitedParam}/{pipeDelimitedParam}/{deepObjectParam},GET,pipeDelimitedParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1.",
        "Styles,/path/object/{matrixParam}/{labelParam}/{formParam}/{simpleParam}/{spaceDelimitedParam}/{pipeDelimitedParam}/{deepObjectParam},GET,deepObjectParam: Empty object values not allowed for non-nullable parameter -- using minProperties=1."
                    ),
      Arrays.asList(
        ...
        "Styles,/cookie/object,GET,spaceDelimitedParam: style=spaceDelimited is not applicable for a cookie parameter. Using style=form instead.",
