...
public class OneOfSchemaTest extends OpenApiTest
  {
  /**
   * Tests {@link TcasesOpenApi#getRequestInputModel getRequestInputModel} using the following oneOf schema.
   * <P>
  ...
  public void Schema_4()
    ...
    assertRequestInputModelFailure(
      "oneOf-4",
      "Error processing OneOf, /oneOf, POST, param0",
      "\"oneOf\" members accept types=[number, object] but not types=[string]");
    }
  }
