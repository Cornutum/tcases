...
all of the issues about how an API test program can be constructed.
...
### Java doesn't work for me. I need tests to be written in another language ###

### JUnit tests are fine, but I want to use a different request execution interface ###

### If I'm adding extensions to Tcases, do I have to create my own fork? ###

### How can I test my own `TestWriter` or `TestCaseWriter` implementation? ###
...
<ul>
  <li class="tw"> writeTestCase
    <li class="tcw"> writeTestCase </li>
  </li>
</ul>
