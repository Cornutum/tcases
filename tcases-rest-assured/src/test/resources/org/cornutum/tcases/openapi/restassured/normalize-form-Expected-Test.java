...
public class NormalizeFormTest {
    ...
    public void getCookieObject_NonEmptyValuePropertiesWidthType_Is_Null() {
        given()
            ...
            .cookie( "width", "0")
            .cookie( "height", "0")
            .cookie( "wmcosailavwu", "ppmqtgj,kVU,xhk,935.4")
            .cookie( "ztg", "375.3")
            .cookie( "sxiso", "true")
            .cookie( "width", null)
            .cookie( "width", null)
    ...
    public void getCookieObject_NullableValuePropertiesHeightValue_Is_Gt_0() {
        given()
            .baseUri( forTestServer())
            .cookie( "deep[width]", "0")
            .cookie( "height", "144325543")
            .cookie( "ehr", "wxknlugzcxldftok,-588.2,xssjhoezflfzlm,true,wxskhytnwgmk,true")
            .cookie( "ptifryawqwqvqy", "g&F")
            .cookie( "width", "0")
            .cookie( "height", "0")
        .when()
            .request( "GET", "/cookie/object")
    ...
    public void getQueryObject_NonEmptyValuePropertiesHeightValue_Is_Gt_0() {
        given()
            ...
            .queryParam( "height", (String) null)
            .queryParam( "mpkbvvosossjwsw", "963.6")
            .queryParam( "zblylgbd", "true")
            .queryParam( "ypttqjfrilug", "-889.7")
    ...
    public void getQueryObject_NullableValuePropertiesHeightValue_Is_Gt_0() {
        given()
            .baseUri( forTestServer())
            .queryParam( "deep[width]", "0")
            .queryParam( "height", "556362815")
            .queryParam( "ljsbkwqz", "")
            .queryParam( "bbptfpytc", "SVmj8~t")
            .queryParam( "ibptsudv", "")
            .queryParam( "width", "0")
            .queryParam( "height", "0")
        .when()
