...
public class NormalizeLabelTest {
    ...
    public void getPathArrayEmptyNonEmptyNullableExploded_EmptyItemsSize_Is_1() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "exploded", ".-502866499")
                .pathParam( "nullable", ".-178922770")
    ...
    public void getPathArrayEmptyNonEmptyNullableExploded_EmptyItemsSize_Is_Gt_1() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "exploded", "..324498561.-447569366.-246773701.391059911.1051980808.-587451820.-606844601.-423775159.-847400667.-1052151849.-986748104.1041524851.536130786")
                .pathParam( "nullable", "..1022475891.1071792615.1003304817.-371443331.-118750903.-743637375.508438038.617143212.-190189331.288416967.-834544207.184418481")
    ...
    public void getPathArrayEmptyNonEmptyNullableExploded_NullableItemsContainsValue_Is_Gt_0() {
        Response response =
            given()
                .baseUri( forTestServer())
                .pathParam( "exploded", ".268536239.621480451.1047340513.-789247164.-287886212.646483382.-104528854.994637034.496226084.423537660.24282505.691777861.691777861.-224601062.-43482798.762468838")
                .pathParam( "nullable", ".331672103.939308768.-893662531.-874186250.-213851462.-772744928.-690599939.-661964290.-468691461.-228899221.-690599939.-69920141.-57884003")
    ...
    public void getPathObjectNonEmptyNullableExploded_NonEmptyValuePropertyCount_Is_Gt_0() {
        Response response =
            given()
                ...
                .pathParam( "nullable", ".width.0.height.0.ahuuzljs.821.0")
    ...
    public void getPathObjectNonEmptyNullableExploded_NonEmptyValuePropertiesWidthValue_Is_Gt_0() {
        Response response =
            given()
                ...
                .pathParam( "nullable", ".height..rzwb.-597.bipkjfxbd.]s rPt/*")
    ...
    public void getPathObjectNonEmptyNullableExploded_NonEmptyValuePropertiesHeightValue_Is_Gt_0() {
        Response response =
            given()
                ...
                .pathParam( "nullable", ".width.4449220")
    ...
    public void getPathObjectNonEmptyNullableExploded_NullableValuePropertiesHeightValue_Is_Gt_0() {
        Response response =
            given()
                ...
                .pathParam( "nullable", ".height.68160380.eimgdokpxsjxige./c,PS{u{j>X.kvljgvoab.%")
