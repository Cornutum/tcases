...
public class RequestTestDef7Test {

    @ClassRule
    public static MocoJunitRunner runner = MocoJunitRunner.jsonHttpRunner( 321, pathResource( "org/cornutum/tcases/openapi/moco/any-Moco.json"));
